            ...
            <form onSubmit={saveTask} id="task-form">
                ...
                <div className="justify-content-center row"> 
                    <label className="modal-subtitle col text-center"><b>Tarea</b>     
                        <textarea onChange={event => setTextResponse(event.target.value)} value={textResponse} id="action-text" className="text-box shdw" placeholder={'Ingrese Nueva Tarea'} name="answer-task" maxlength="1000" />
                    </label>
                </div>
                <div id="task-form-buttons" className="row">
                    <div id="new-edit-buttons" className="col">
                        <input type="submit" value="Guardar" id="task-send" className="shdw save btn m-2 float-right" title="Guardar"/>
                    </div>
                </div>
            </form>
            <button type="button" id="task-close" className="shdw discard btn m-2 float-right" title="Descartar" onClick={noSaveTask}>
                Descartar Cambios
            </button>
        </div>
        { alertShow &&
