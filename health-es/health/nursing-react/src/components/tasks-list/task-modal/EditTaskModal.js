                ...
                <div className="container">
                    ...
                    <form onSubmit={saveTask} id="task-form" className="form-container">
                        ...
                        <div className="row">                            
                            ...
                            <div id="task-done-time" className="col time-box shdw" title="Si el momento que figura en este sector ya pasó, la tarea se guardará como cumplida en ese momento">
                                <p className="text-center modal-subtitle">Se Cumplió o Cumplirá</p>
                        ...
                        <div id="task-form-buttons" className="row">
                            <div id="new-edit-button" className="col ml-3">
                                <input type="submit" value="Guardar Edición" id="task-send" className="shdw save btn m-1" title="Guardar"/>
                                <button onClick={doneTask} id="task-done" className="shdw done btn m-1" title="Recién Cumplida">Recién Cumplida</button>
                            </div>
                            <div className='col border border-secondary mt-1 mb-4 mx-4'>
                                <button onClick={deleteTask} id="task-delete" className="shdw delete btn m-1 float-left" title="Eliminar Tarea">Eliminar Tarea</button>
                    ...
                    <button type="button" id="task-close" className="shdw discard btn mx-3 mb-2 float-right" title="Descartar" onClick={noSaveTask}>
                        Descartar Cambios
                    </button>
                </div>
            </section>
