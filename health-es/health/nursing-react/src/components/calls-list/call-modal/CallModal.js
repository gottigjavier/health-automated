          ...
          <div className="container">
            ...
            <>
              ...
              <div className="justify-content-center row">
                <label className="modal-subtitle col text-center mt-1"><b>Respuesta</b>     
                  <textarea onChange={event => setTextResponse(event.target.value)} value={textResponse} id="answer-text" className="text-box shdw" placeholder="Respuesta sin novedad (por defecto)" name="answer-call" maxlength="1000" />
                </label>
              </div>
              <div id="new-form-buttons" className="row">
                <div id="new-edit-buttons" className="col">
                <input type="submit" value="Cerrar y Guardar" id="answer-call-send" className="shdw save btn m-2 float-right" title="Enviar"/>
                </div>
              </div>
            </form>
                  <button type="button" id="answer-close" className="shdw discard btn m-2 float-right" title="Descartar" onClick={noSaveCall}>
                    Descartar Cambios
                  </button>
            </>
            :
            ...
            <div className="row justify-content-center call-modal-title">
              ...
              <div className="row">                            
                  ...
                  <button type="button" id="answer-close" className="shdw discard btn m-2 float-right" title="Cerrar" onClick={noSaveCall}>
                    Cerrar
                  </button>
            </>
            }
